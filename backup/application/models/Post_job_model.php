            ...
            foreach($data->result_array() as $row) {
                ...
                <div class="emply-resume-list col-lg-6 col-md-6 col-sm-12">
                    <div class="DataContainer">
                        <div class="emply-resume-info" style="min-height: 150px;"><h3><a  style="width: 100% !important" href="#" title="">'.$row["post_title"].'</a></h3><span>'.$row['category_name'].'</span><span>'.$row['sub_category_name'].' </span><p><i class="la la-map-marker"></i>'. $row['location'].'</p><p>'.$desc.'</p></div><div class="shortlists" style="width:50px;">
