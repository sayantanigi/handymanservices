                        ...
                        <div class="slide" style="background:dodgerBlue;">
                            ...
                            <?php } elseif (in_array($extension, ['mp4', 'webm', 'avi', 'mov'])) { ?>
                                <video controls style="width: 100%;height: 100%;object-fit: cover;">
                                    <source src="<?= base_url('uploads/users/background/' . $sample['filecontent']); ?>"
                                        type="video/mp4">
            ...
            <div class="row">
                <div class="col-lg-12 column">
                    <div class="job-single-sec style3">
                        <div class="job-head-wide" style="border-bottom: 0px !important;">
                            <div class="row">
                                                ...
                                                <div class="job-listings-sec no-border">
                                                    ...
                                                    <div class="job-listing wtabs noimg col-lg-6 col-md-6 col-sm-12">
                                                        <div class="CustomBlockDesign">
                                                            <div id="slider1" style="border-radius: 15px;">
                                                                <?php
                                                                ...
                                                                if (in_array($extension, ['jpg', 'jpeg', 'png', 'gif', 'bmp', 'avif', 'webp'])) { ?>
                                                                <img src="<?= base_url("uploads/postjob/" . $sample['job_image']) ?>" alt="Image" style="border-radius: 0px;">
                                                                <?php } elseif (in_array($extension, ['mp4', 'webm', 'avi', 'mov'])) { ?>
                                                                ...
                                                                <?php } ?>
                                                                <span class="controls1" onclick="prevSlide1(-1)" id="left-arrow1"><i class="fa fa-arrow-left" aria-hidden="true"></i></span>
                                                                <span class="controls1" id="right-arrow1" onclick="nextSlide1(1)"><i class="fa fa-arrow-right" aria-hidden="true"></i></span>
                                                            </div>
                                                            <div id="dots-con1">
                                ...
                                <div class="col-lg-4 col-md-12 col-sm-12 column">
                                    ...
                                    if ($_SESSION['afrebay']['userId'] != base64_decode($uri)) { ?>
                                        <div class="job-overview">
                                            ...
                                            <form method="post"
                                                action="<?= base_url('user/dashboard/save_employer_rating') ?>">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-sm-12 Form_Subject">
                                                        ...
                                                        <input type="hidden" value="<?= @base64_decode($uri) ?>"
                                                            name="user_id">
                                                        <input type="hidden"
                                                            value="<?= @$_SESSION['afrebay']['userType'] ?>"
                                                            name="userType">
                                                    </div>
                                    ...
                                    <div class="Product_Details">
                                        ...
                                        <div class="row">
                                            <?php foreach ($getSavedPost as $value) {
                                                ...
                                                $post_detailsimg = $this->db->query("SELECT * FROM postjob_image WHERE job_id = '" . $value['post_id'] . "'")->result_array(); ?>
                                                <div class="col-lg-4 col-md-6 col-sm-12 column">
                                                    <div class="Product">
                                                        <div class="Product_Img">
                                                            <div id="slider2" style="border-radius: 15px;">
                                                                <?php
                                                                foreach ($post_detailsimg as $sample) { ?>
                                                                    <div class="slide2">
                                                                        <?php
                                                                        if (!empty($sample['job_image']) && file_exists('uploads/postjob/' . $sample['job_image'])) {
                                                                            $extension = strtolower(pathinfo($sample['job_image'], PATHINFO_EXTENSION));
                                                                ...
                                                                <?php } ?>
                                                                <span class="controls2" onclick="prevSlide2(-1)" id="left-arrow2"><i class="fa fa-arrow-left" aria-hidden="true"></i></span>
                                                                <span class="controls2" id="right-arrow2" onclick="nextSlide2(1)"><i class="fa fa-arrow-right" aria-hidden="true"></i></span>
                                                            </div>
                                                            <div id="dots-con2">
                                                                <?php foreach ($post_detailsimg as $sample) { ?>
                                                        ...
                                                        <div class="Product_Data">
                                                            <p class="mt-2 mb-2">
                                                                <span><?php echo $post_details->post_title ?></span></p>
                                                            <?php $userDetails = $this->db->query("SELECT * FROM users WHERE userId = '" . $value['user_id'] . "'")->row(); ?>
                                                            <p><span><?= $userDetails->username; ?></span>
                                                            </p>
                                                            <a href="<?php echo base_url() ?>workdetail/<?php echo base64_encode($value['post_id']) ?>"
                                                                type="button" class="btn btn-info Gradient_Back_Color">View
                                                                Post</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            if (!empty($reviewData)) {
                                                foreach ($reviewData as $data) { ?>
                                                    <div class="Comment_Block_Container"
                                                        style="flex-direction: row; align-items: flex-start; justify-content: flex-start; display: flex; width: 100%; margin-bottom: 10px">
                                                        ...
                                                        <div class="User_Comment_Data"
                                                            ...
                                                            <div class="replyPost">
                                                                ...
                                                                <p style="margin-bottom: 0; ">Rating:
                                                                    <?= displayStars($data['rating']); ?></p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                <?php }
...
<div class="Map_Viwe" id="MapView">
    <div class="Map_Module">
        ...
        <div class="Map_Container">
            <iframe src="https://maps.google.it/maps?q=<?= @$userdata->address ?>&output=embed" height="70%"
