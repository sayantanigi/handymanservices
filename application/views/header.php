                            ...
                            <nav>
                                <ul>
                                    ...
                                    if (!empty(@$_SESSION['afrebay']['userId'])) { ?>
                                        ...
                                        <!-- <li class="">
                                        <a href="<?= base_url('findwork') ?>" title="" class="<?php if ($uri == 'findwork') {
                                                                                                    echo "active";
                                                                                                } else {
                                                                                                    echo "";
                                                                                                } ?>">
                                            <i class="fa-solid fa-briefcase"></i><?php if ($uri == 'findwork') {
                                                                                        echo " Find Work";
                                                                                    } else {
                                                                                        echo "";
                                                                                    } ?>
                                    ...
                                    <li class="">
                                        <a href="<?= base_url('professionals') ?>" title="" class="<?php if ($uri == 'professionals') {
                                                                                                        echo "active";
                                                                                                    } else {
                                                                                                        echo "";
                                                                                                    } ?>">
                                            <i class="fa-solid fa-user-group"></i><?php if ($uri == 'professionals') {
                                                                                        echo " Professionals";
                                                                                    } else {
                                                                                        echo "";
                                                                                    } ?>
                                    ...
                                    <li class="">
                                        ...
                                        if (!empty(@$_SESSION['afrebay']['userId'])) {
                                            if (is_numeric(@$_SESSION['afrebay']['userId'])) { ?>
                                                <a href="<?= base_url('chat') ?>" title="Messages" class="<?php if ($uri == 'chat') {
                                                                                                                echo "active";
                                                                                                            } else {
                                                                                                                echo "";
                                                                                                            } ?>">
                                                    <i class="fa-solid fa-comment-dots"></i><?php if ($uri == 'chat') {
                                                                                                echo " Messages";
                                                                                            } else {
                                                                                                echo "";
                                                                                            } ?></a>
