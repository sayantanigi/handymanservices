                    ...
                    <div class="fixdPosthead sticky-top">
                        <?php if (!empty($_SESSION['afrebay']['userType'])) { ?>
                            ...
                            <?php } else { ?>
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="flex-fill w-100">
                                        ...
                                        <div class="uploadOptionPost">
                                            <div data-toggle="modal" <?php if (!empty($_SESSION['afrebay']['userType'])) {
                                                                            echo 'data-target="#postModal" onclick="postData()"';
                                                                        } else {
                                                                            echo '';
                                                                        } ?>>
                                ...
                                <!-- <div class="d-flex justify-content-between tabpost align-items-center mb-lg-3 mb-2">
                                                                ...
                                                                <div class="Comment_Block_Container" style="flex-direction: row; align-items: flex-start; justify-content: flex-start; display: flex; width: 100%;">
                                                                    ...
                                                                    <div class="User_Comment_Data" style="width: 92%; display: flex; flex-direction: column;">
                                                                        ...
                                                                        <div class="replyBox mt-3" id="replyBox_<?= $each['id']; ?>">
                                                                            ...
                                                                            <div class="uploadOptionPost">
                                                                                <div data-toggle="modal" data-target="#postModal" onclick="postData()" style="margin-top: 20px;">
                        ...
                        <div class="add-sidebar sticky-top">
                            ...
                            ?>
                                <div class="ProfileBlock mb-3">
                                    ...
                                    <p class="text-center memberinfo"><?= 'Member Since ' . date('M Y', strtotime($userData->created)) ?> . <?php if ($userData->userType === '1') {
                                                                                                                                                echo "Professional";
                                                                                                                                            } else {
                                                                                                                                                echo "Customer";
                                                                                                                                            } ?></p>
