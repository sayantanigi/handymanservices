		...
		if(empty($validate)) {
			...
			if(!empty($insert_id)) {
				...
				try {
					...
					$mail->IsHTML(true);
					$mail->Subject = 'Verify Your Email Address From Side Quote';
