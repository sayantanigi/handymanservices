...
class Reportedusers_model extends My_Model {
    var $column_order = array(null, 'report_user.to_user_id', 'report_user.from_user_id', 'report_user.reason', null); //set column field database for datatable orderable
    var $order = array('id' => 'DESC');
    function __construct() {
        parent::__construct();
    }
    private function _get_datatables_query() {
        $this->db->select('report_user.*');
